...
export default function ConsentScreen() {
    ...
    return (
        ...
        <ScrollView style={globalStyles.scrollViewContainer}
            ...
            <Text style={[styles.paragraph, globalStyles.text]}>
            ...
            <Text style={globalStyles.sectionTitle}>What will happen to the results of my personal information?</Text>
            <Text style={[styles.paragraph, globalStyles.text]}>
            ...
            <View style={styles.indentedList}>
                <Text style={globalStyles.text}>• I understand that by signing below I am agreeing to take part in the University of Sussex research described here, and that I have read and understood this information sheet.</Text>
                <Text style={globalStyles.text}>• I understand that my participation is entirely voluntary, that I can choose not to participate in part or all of the study,
                ...
                <Text style={globalStyles.text}>• I understand I can request without penalty that my contact details can be withdrawn and deleted after testing is complete. Your experimental data (the responses we record during the study) can be withdrawn prior to data analysis (4 weeks after date of testing).</Text>
                ...
                <Text style={globalStyles.text}>• I understand that my collected data will be stored using only my research participant code I understand my data, identified by participant code only, may be made publicly available through online data repositories or at the request of other researchers.</Text>
                <Text style={globalStyles.text}>• I understand that my participation will remain confidential in any written reports of this research, and that no information I disclose will lead to the identification in those reports of any individual either by the researchers or by any other party, without first obtaining my written permission.</Text>
            </View>
            <View style={styles.consentOptionsContainer}>
                <View style={styles.checkboxContainer}>
                    ...
                    />
                    <Text style={globalStyles.text}>Our research group at the University of Sussex carries out studies on colour vision and colour perception.
            ...
            <View style={styles.codeSection}>
                ...
                <View style={styles.codeItem}>
                    <Text style={globalStyles.text}>3. Please enter the first letter of the street where you live:</Text>
                    <TextInput
                        style={globalStyles.input}
                        value={codeStreet}
                ...
                <View style={styles.codeItem}>
                    <Text style={globalStyles.text}>4. Please enter the final digit of your mobile phone number:</Text>
                    <TextInput
                        style={globalStyles.input}
                        value={codePhone}
            ...
            <Text style={[styles.paragraph, globalStyles.text]}>This study may have additional runs, and you may be invited back for further testing sessions.
